                        ...
                        <div class="card-body p-2">
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col-auto col-lg-auto col-sm-auto ml-auto ml-lg-auto mr-auto mr-lg-auto">
                                    <a href="{{Route('planillas.show',$planilla)}}" class="btn btn-lg btn-info center" ><i class="fas fa-pencil-alt mr-1"></i>Calificar</a>
                                </div>
                            </div>

                            {!! Form::model($planilla,['route' => ['planillas.update',$planilla], 'method' => 'PUT','class' => 'form-horizontal form-bordered', 'id'=>'slides']) !!}
                                <div class="row mt-1">
                                    <div class="col-lg-2 col-2">
                                      ...
                                      <div class="col-lg-2  offset-lg-5  col-2 offset-6 ">
                                            <div class="col-sm-7 mt-lg-3 col-lg-6 col-xl-6  mt-3 switch switch-sm switch-warning" data-toggle="tooltip" data-placement="top" title="Bloquear/Desbloquear">
                                                <a href="{{route('planillas.reset',$planilla)}}"  class="mb-1 mt-1 mr-1 btn btn-xs btn-danger">Reset</a>
                                            </div>
                                     </div>
                                </div>
                            {!! Form::close() !!}
