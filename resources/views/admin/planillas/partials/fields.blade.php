<div class="form-group row ml-4 mr-4">
    {!! Form::label('name', 'Docente: ',['class'=>'control-label']) !!}
...
<div class="form-group row ml-4 mr-4">
    ...
    {!! Form::select('anio',$anios, null, ['class' => 'form-control mb-3','placeholder'=>'Seleccione un Año', 'id'=>'anio','required','data-url'=>route('anios.show',':ID')]) !!}
</div>
<div class="form-group row ml-4 mr-4">
    {!! Form::label('name', 'Periodo: ',['class'=>'control-label']) !!}
    {!! Form::select('periodo_id',[], null, ['class' => 'form-control mb-3','placeholder'=>'Seleccione un periodo', 'id'=>'periodo','required']) !!}
</div>
<script>
    $("#anio").change(event => {
