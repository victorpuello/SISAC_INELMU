...
<div id="modalLogros" class="modal-block modal-block-sm modal-header-color modal-block-primary mfp-hide">
    <section class="card">
        ...
        <div class="card-body">
            {!! Form::open(['route' => 'reportes.academico.logros', 'method' => 'POST','class' => 'form-horizontal form-bordered', 'id' => 'form-create']) !!}
            <div class="modal-wrapper pt-0">
                <div class="modal-icon mt-5">
                    <i class="fas fa-print mt-2"></i>
                </div>
                <div class="modal-text ">
                    ...
                    <div class="form-group mb-0 pb-0">
                        ...
                        {!! Form::select('docente',$docentes, null, ['class' => 'form-control', 'id'=>'w1-username','required', 'placeholder'=>'Seleccione un docente']) !!}
                    </div>
                    <div class="form-group mb-0 pb-0">
                        <label class="control-label text-sm-right " for="w1-username">Grado: </label>
                        {!! Form::select('grade',$grados, null, ['class' => 'form-control', 'id'=>'w1-username','required', 'placeholder'=>'Seleccione un grupo']) !!}
                    </div>
                    <div class="form-group mb-0 pb-0">
...
<div id="modalInforme" class="modal-block modal-block-sm modal-header-color modal-block-success mfp-hide">
    <section class="card">
        ...
        <div class="card-body">
            {!! Form::open(['route' => 'reportes.academico', 'method' => 'POST','class' => 'form-horizontal form-bordered', 'id' => 'form-create']) !!}
            <div class="modal-wrapper pt-0">
                <div class="modal-icon mt-5">
                    <i class="fas fa-print mt-2"></i>
                </div>
