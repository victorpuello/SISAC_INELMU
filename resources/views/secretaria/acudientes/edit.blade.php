...
@section('content')
    <section class="card card-featured card-featured-primary mb-4">
        ...
        <div class="card-body">
            @include('secretaria.users.partials.messages')
            {!! Form::model($acudiente,['route' => ['secretaria.acudiente.update',$acudiente], 'method' => 'PUT','class' => 'form-horizontal form-bordered']) !!}
