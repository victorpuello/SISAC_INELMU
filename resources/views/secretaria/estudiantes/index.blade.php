...
@section('content')
    <div class="card-body">
        <div class="row" id="ControlPanel">
            <div class="col-sm-6">
                <div class="mb-3">
                    <a href="{{route('secretaria.estudiantes.create')}}"  class="btn btn-primary on-default ajax-estudiantes ">Agregar <i class="fas fa-plus"></i></a>
                </div>
            </div>
        </div>
    ...
    <div id="inf"
         data-urltabla ="{{route('secretaria.estudiantes.index')}}">
    </div>
@endsection
@section('script')
