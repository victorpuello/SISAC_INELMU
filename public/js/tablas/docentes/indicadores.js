                ...
                columns: [
                    ...
                    {data: "descripcion", orderable: true, searchable: true },
                    {
                        data: "id", render: function (data, type, row) {
                            return '<a href="' + inf.data('url') + "/docente/indicadors/" + data + '/edit"' + ' class="on-default edit-row simple-ajax-modal"><i class="fas fa-pencil-alt"></i></a>  ' +
                                //'<a href="' + inf.data('url') + '/admin/areas/' + data +'" class="on-default show-row"><i class="far fa-eye"></i></a>   ' +
                                '<a href="#modalEliminar" data-nasg ="'+row.indicador+'" data-urldestroy = "' + inf.data('url') + '/docente/indicadors/' + data +'" class="on-default remove-row modal-basic " >' +
